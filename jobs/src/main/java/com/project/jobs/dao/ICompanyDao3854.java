...
public interface ICompanyDao3854 {
   ...
   List<Company> getCompaniesByPage(@Param("offset") int offset, @Param("pageSize") int pageSize, @Param("mem_no") Long mem_no);
   int getTotalCompanyCount(@Param("mem_no") Long mem_no);
