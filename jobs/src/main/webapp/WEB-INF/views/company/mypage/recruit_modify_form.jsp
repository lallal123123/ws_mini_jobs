...
<div class="row">
    ...
    <div class="col-9 mb-5">
	    <p class="text-secondary d-flex">
	    	...
	    	<a href="" class="nav-link text-black fw-bolder font-size-">채용 공고 수정</a>
	    </p>
    
        <div class="border p-5 rounded">
        	<form id="recruit_modify_form" action="/company/mypage/modifyRecruit" method="post" onsubmit="return numberCheck()">
        		...
        		<div class="mb-3">
			  		...
			  		<input type="text" class="form-control" name="title" id="title" placeholder="공고제목" value="${recruit.title }">
				</div>
	        	<div class="mb-3">
			  		<label for="" class="form-label">공고 마감일</label>
			  		<input type="date" class="form-control" name="deadline_date" id="deadline_date" placeholder="ex)2024-00-00" value="${recruit.deadline_date }">
				</div>
				<div class="mb-5">
			  		<label for="" class="form-label">직급</label>
			  		<input type="text" class="form-control" name="rank" id="rank" placeholder="직급" value="${recruit.rank }">
				</div>
				<h4 class="mt-2 fs-5">지원자격</h4>
				<div class="mb-3">
			  		<label for="" class="form-label">경력</label>
			  		<input type="text" class="form-control" name="career" id="career" placeholder="경력" value="${recruit.career }">
				</div>
				<div class="mb-3">
			  		<label for="" class="form-label">학력</label>
			  		<input type="text" class="form-control" name="education " id="education " placeholder="학력"  value="${recruit.education }">
				</div>
				<div class="mb-5">
			  		<label for="" class="form-label">스킬</label>
			  		<input type="text" class="form-control" name="skill " id="skill " placeholder="스킬" value="${recruit.skill }">
				</div>
				
				<h4 class="mt-2 fs-5">근무조건</h4>
				<div class="mb-3">
			  		<label for="" class="form-label">고용형태</label>
			  		<select class="form-select" name="field" id="field" value="${recruit.field }">
				...
				<div class="mb-3">
			  		...
			  		<input type="number" class="form-control" name="pay" id="pay" placeholder="급여" value="${recruit.pay }">
				</div>
				<div class="mb-3">
			  		<label for="" class="form-label">지역</label>
			  		
			  		<select class="form-select" name="location" id="location" value="${recruit.location }">
				...
				<div class="mb-3">
			  		...
			  		<input type="text" class="form-control" name="working_time" id="working_time" placeholder="시간"  value="${recruit.working_time }">
				</div>
				<div class="mb-5">
			  		<label for="" class="form-label">모집인원</label>
			  		<input type="number" class="form-control" name="p_number" id="p_number" placeholder="모집인원"  value="${recruit.p_number }">
				</div>
				
				<h4 class="mt-2 fs-5">상세요건</h4>
				<div class="mb-3">
			  		<label for="" class="form-label">자격요건</label>
			  		<textarea class="form-control" name="qualification" id="qualification" placeholder="자격요건를 자세히 적어주세요">${recruit.qualification }</textarea>
				</div>
				<div class="mb-3">
			  		<label for="" class="form-label">전형절차</label>
			  		<textarea class="form-control" name="seprocedure" id="seprocedure" placeholder="전형절차를 자세히 적어주세요">${recruit.seprocedure }</textarea>
				</div>
				<div class="mb-3">
			  		<label for="" class="form-label">복지</label>
			  		<textarea class="form-control" name="welfare" id="welfare" placeholder="복지내용을 자세히 적어주세요">${recruit.welfare }</textarea>
				</div>
				<div class="mb-3">
			  		<label for="" class="form-label">유의사항</label>
			  		<textarea class="form-control" name="notice" id="notice" placeholder="유의사항을 자세히 적어주세요">${recruit.notice }</textarea>
				</div>
