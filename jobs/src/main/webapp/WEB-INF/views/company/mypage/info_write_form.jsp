...
<div class="row">
    ...
    <div class="col-9">
	    <p class="text-secondary d-flex">
	    	...
	    	<a href="" class="nav-link text-black fw-bolder font-size-">기업 소개 작성</a>
	    </p>
    
        <div class="border p-5 rounded">
        
        	<form action="/company/mypage/infoWrite" method="post">
        		<input type="text" name="com_no" value="${company.com_no}">
				<div class="mb-3">
					<label for="" class="form-label">소개글</label>
					<textarea class="form-control" name="introduction" id="introduction" placeholder="기업에 대한 소개글을 작성해주세요"></textarea>
			 	</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<select class="form-select" name="sectors" id="sectors">
				...
				<div class="mb-3">
					...
					<textarea class="form-control" name="pension" id="pension" placeholder="의무가입하는 연금보험 내용을 작성해주세요"></textarea>
			 	</div>
				<div class="mb-3">
					<label for="" class="form-label">보수/지원/수당</label>
					<textarea class="form-control" name="compensation" id="compensation" placeholder="보수/지원/수당 내용을 작성해주세요"></textarea>
			 	</div>
				<div class="mb-3">
					<label for="" class="form-label">사내시설</label>
					<textarea class="form-control" name="facilities" id="facilities" placeholder="사내시설에 대해 작성해주세요"></textarea>
			 	</div>
				<div class="mb-3">
					<label for="" class="form-label">사내제도/성장</label>
					<textarea class="form-control" name="policy" id="policy" placeholder="사내제도/성장에 대해 작성해주세요"></textarea>
			 	</div>
				 <div class="mb-3">
					<label for="" class="form-label">편의/여가/건강</label>
					<textarea class="form-control" name="convenience" id="convenience" placeholder="편의/여가/건강에 대해 작성해주세요"></textarea>
			 	</div>
				 <div class="mb-3">
					<label for="" class="form-label">설립연도</label>
					<input type="number" class="form-control" name="establishment" id="establishment" placeholder="설립연도">
			 	</div>
        		<div class="mb-3">
			  		<label for="" class="form-label">사원수</label>
			  		<input type="number" class="form-control" name="p_number" id="p_number" placeholder="사원수">
				</div>
				<div class="mb-3">
					<label for="" class="form-label">연혁</label>
					<textarea class="form-control" name="history" id="history" placeholder="연혁 내용을 작성해주세요"></textarea>
			 	</div>
				 <div class="mb-3">
					<label for="" class="form-label">인재상</label>
					<textarea class="form-control" name="ideal_talent" id="ideal_talent" placeholder="인재상에 대해 작성해주세요"></textarea>
			 	</div>
